...
public class CallProperties {
	...
	public static final String SZEF_NAME="Prezes Drzymała";
	public static final String HR_NUM="403";
	public static final String HR_NAME="Dział HR";
	public static final String REKLAMACJA_1_NUM="501";
	public static final String REKLAMACJA_1_NAME="Dział reklamacji 1";
