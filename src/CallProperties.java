...
public class CallProperties {
	...
	public static final String SECRETARY_NUM = "403";
	public static final String SZEF_NUM="501";
	public static final String HR_NUM="400";
	public static final String REKLAMACJA_1_NUM="501";
	public static final String REKLAMACJA_2_NUM="400";
	
	public static final String LOCALHOST="194.29.169.100";
